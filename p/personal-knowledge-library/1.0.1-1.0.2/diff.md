# Comparing `tmp/personal_knowledge_library-1.0.1.tar.gz` & `tmp/personal_knowledge_library-1.0.2.tar.gz`
...
### Comparing `personal_knowledge_library-1.0.1/setup.py` & `personal_knowledge_library-1.0.2/setup.py`
