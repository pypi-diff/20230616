# Comparing `tmp/tencentcloud-sdk-python-oceanus-3.0.915.tar.gz` & `tmp/tencentcloud-sdk-python-oceanus-3.0.916.tar.gz`
...
## Comparing `tencentcloud-sdk-python-oceanus-3.0.915.tar` & `tencentcloud-sdk-python-oceanus-3.0.916.tar`
...
### Comparing `tencentcloud-sdk-python-oceanus-3.0.915/README.rst` & `tencentcloud-sdk-python-oceanus-3.0.916/README.rst`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-oceanus-3.0.915/tencentcloud/__init__.py` & `tencentcloud-sdk-python-oceanus-3.0.916/tencentcloud/__init__.py`
...
### Comparing `tencentcloud-sdk-python-oceanus-3.0.915/tencentcloud/oceanus/v20190422/errorcodes.py` & `tencentcloud-sdk-python-oceanus-3.0.916/tencentcloud/oceanus/v20190422/errorcodes.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-oceanus-3.0.915/tencentcloud/oceanus/v20190422/models.py` & `tencentcloud-sdk-python-oceanus-3.0.916/tencentcloud/oceanus/v20190422/models.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-oceanus-3.0.915/tencentcloud/oceanus/v20190422/oceanus_client.py` & `tencentcloud-sdk-python-oceanus-3.0.916/tencentcloud/oceanus/v20190422/oceanus_client.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-oceanus-3.0.915/PKG-INFO` & `tencentcloud-sdk-python-oceanus-3.0.916/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-oceanus-3.0.915/setup.py` & `tencentcloud-sdk-python-oceanus-3.0.916/setup.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-oceanus-3.0.915/tencentcloud_sdk_python_oceanus.egg-info/PKG-INFO` & `tencentcloud-sdk-python-oceanus-3.0.916/tencentcloud_sdk_python_oceanus.egg-info/PKG-INFO`
