# Comparing `tmp/llm_client-0.6.0.tar.gz` & `tmp/llm_client-0.6.1.tar.gz`
...
### Comparing `llm_client-0.6.0/.DS_Store` & `llm_client-0.6.1/.DS_Store`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/.github/workflows/test.yml` & `llm_client-0.6.1/.github/workflows/test.yml`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/llm_client/__init__.py` & `llm_client-0.6.1/llm_client/__init__.py`
...
### Comparing `llm_client-0.6.0/llm_client/llm_api_client/ai21_client.py` & `llm_client-0.6.1/llm_client/llm_api_client/ai21_client.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/llm_client/llm_api_client/aleph_alpha_client.py` & `llm_client-0.6.1/llm_client/llm_api_client/aleph_alpha_client.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/llm_client/llm_api_client/anthropic_client.py` & `llm_client-0.6.1/llm_client/llm_api_client/anthropic_client.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/llm_client/llm_api_client/base_llm_api_client.py` & `llm_client-0.6.1/llm_client/llm_api_client/base_llm_api_client.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/llm_client/llm_api_client/google_client.py` & `llm_client-0.6.1/llm_client/llm_api_client/google_client.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/llm_client/llm_api_client/huggingface_client.py` & `llm_client-0.6.1/llm_client/llm_api_client/huggingface_client.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/llm_client/llm_api_client/llm_api_client_factory.py` & `llm_client-0.6.1/llm_client/llm_api_client/llm_api_client_factory.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/llm_client/llm_api_client/openai_client.py` & `llm_client-0.6.1/llm_client/llm_api_client/openai_client.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/llm_client/llm_client/local_client.py` & `llm_client-0.6.1/llm_client/llm_client/local_client.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/llm_client/sync/sync_llm_api_client_factory.py` & `llm_client-0.6.1/llm_client/sync/sync_llm_api_client_factory.py`
...
### Comparing `llm_client-0.6.0/new_venv/bin/activate` & `llm_client-0.6.1/new_venv/bin/activate`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/activate.csh` & `llm_client-0.6.1/new_venv/bin/activate.csh`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/activate.fish` & `llm_client-0.6.1/new_venv/bin/activate.fish`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/activate.nu` & `llm_client-0.6.1/new_venv/bin/activate.nu`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/activate.ps1` & `llm_client-0.6.1/new_venv/bin/activate.ps1`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/activate_this.py` & `llm_client-0.6.1/new_venv/bin/activate_this.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/deactivate.nu` & `llm_client-0.6.1/new_venv/bin/deactivate.nu`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/get_objgraph` & `llm_client-0.6.1/new_venv/bin/get_objgraph`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/publish.py` & `llm_client-0.6.1/new_venv/bin/publish.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/rst2html.py` & `llm_client-0.6.1/new_venv/bin/rst2html.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/rst2html4.py` & `llm_client-0.6.1/new_venv/bin/rst2html4.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/rst2html5.py` & `llm_client-0.6.1/new_venv/bin/rst2html5.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/rst2latex.py` & `llm_client-0.6.1/new_venv/bin/rst2latex.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/rst2man.py` & `llm_client-0.6.1/new_venv/bin/rst2man.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/rst2odt.py` & `llm_client-0.6.1/new_venv/bin/rst2odt.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/rst2odt_prepstyles.py` & `llm_client-0.6.1/new_venv/bin/rst2odt_prepstyles.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/rst2pseudoxml.py` & `llm_client-0.6.1/new_venv/bin/rst2pseudoxml.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/rst2s5.py` & `llm_client-0.6.1/new_venv/bin/rst2s5.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/rst2xetex.py` & `llm_client-0.6.1/new_venv/bin/rst2xetex.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/rst2xml.py` & `llm_client-0.6.1/new_venv/bin/rst2xml.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/rstpep2html.py` & `llm_client-0.6.1/new_venv/bin/rstpep2html.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/bin/undill` & `llm_client-0.6.1/new_venv/bin/undill`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/LICENSE.txt` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/3d_drawing/mayavi2_spring.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/3d_drawing/mayavi2_spring.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/3d_drawing/plot_basic.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/3d_drawing/plot_basic.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/WormNet.v3.benchmark.txt` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/WormNet.v3.benchmark.txt`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/hartford_drug.edgelist` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/hartford_drug.edgelist`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_beam_search.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_beam_search.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_betweenness_centrality.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_betweenness_centrality.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_blockmodel.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_blockmodel.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_circuits.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_circuits.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_davis_club.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_davis_club.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_dedensification.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_dedensification.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_girvan_newman.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_girvan_newman.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_iterated_dynamical_systems.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_iterated_dynamical_systems.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_krackhardt_centrality.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_krackhardt_centrality.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_maximum_independent_set.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_maximum_independent_set.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_parallel_betweenness.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_parallel_betweenness.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_rcm.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_rcm.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_snap.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_snap.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_subgraphs.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/algorithms/plot_subgraphs.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/basic/plot_properties.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/basic/plot_properties.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/basic/plot_read_write.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/basic/plot_read_write.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/basic/plot_simple_graph.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/basic/plot_simple_graph.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/chess_masters_WCC.pgn.bz2` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/chess_masters_WCC.pgn.bz2`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/knuth_miles.txt.gz` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/knuth_miles.txt.gz`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_center_node.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_center_node.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_chess_masters.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_chess_masters.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_custom_node_icons.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_custom_node_icons.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_degree.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_degree.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_directed.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_directed.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_ego_graph.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_ego_graph.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_eigenvalues.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_eigenvalues.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_four_grids.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_four_grids.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_house_with_colors.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_house_with_colors.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_knuth_miles.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_knuth_miles.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_labels_and_colors.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_labels_and_colors.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_multipartite_graph.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_multipartite_graph.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_rainbow_coloring.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_rainbow_coloring.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_random_geometric_graph.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_random_geometric_graph.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_sampson.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_sampson.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_selfloops.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_selfloops.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_spectral_grid.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_spectral_grid.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_tsp.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_tsp.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_unix_email.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_unix_email.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/plot_weighted_graph.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/plot_weighted_graph.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/drawing/unix_email.mbox` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/drawing/unix_email.mbox`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/graph/plot_dag_layout.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/graph/plot_dag_layout.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/graph/plot_degree_sequence.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/graph/plot_degree_sequence.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/graph/plot_erdos_renyi.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/graph/plot_erdos_renyi.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/graph/plot_football.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/graph/plot_football.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/graph/plot_morse_trie.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/graph/plot_morse_trie.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/graph/plot_mst.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/graph/plot_mst.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/graph/plot_napoleon_russian_campaign.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/graph/plot_napoleon_russian_campaign.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/graph/plot_roget.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/graph/plot_roget.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/graph/plot_triad_types.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/graph/plot_triad_types.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/graph/plot_words.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/graph/plot_words.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/graph/roget_dat.txt.gz` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/graph/roget_dat.txt.gz`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/graph/words_dat.txt.gz` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/graph/words_dat.txt.gz`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/subclass/plot_antigraph.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/subclass/plot_antigraph.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/doc/networkx-3.1/examples/subclass/plot_printgraph.py` & `llm_client-0.6.1/new_venv/share/doc/networkx-3.1/examples/subclass/plot_printgraph.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/jupyter/labextensions/jupyterlab-plotly/package.json` & `llm_client-0.6.1/new_venv/share/jupyter/labextensions/jupyterlab-plotly/package.json`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/133.f3efd6f2704522ff3b63.js` & `llm_client-0.6.1/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/133.f3efd6f2704522ff3b63.js`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/423.a173fe7fc002e2014c2a.js` & `llm_client-0.6.1/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/423.a173fe7fc002e2014c2a.js`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/478.f7319c49bce7c550ff08.js` & `llm_client-0.6.1/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/478.f7319c49bce7c550ff08.js`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/478.f7319c49bce7c550ff08.js.LICENSE.txt` & `llm_client-0.6.1/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/478.f7319c49bce7c550ff08.js.LICENSE.txt`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/486.6450efe6168c2f8caddb.js` & `llm_client-0.6.1/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/486.6450efe6168c2f8caddb.js`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/657.b28ffbba9c00cc1d1f86.js` & `llm_client-0.6.1/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/657.b28ffbba9c00cc1d1f86.js`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/855.3df3272be51618b38ffb.js` & `llm_client-0.6.1/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/855.3df3272be51618b38ffb.js`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/remoteEntry.d87fbfbef62a029ce69b.js` & `llm_client-0.6.1/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/remoteEntry.d87fbfbef62a029ce69b.js`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/third-party-licenses.json` & `llm_client-0.6.1/new_venv/share/jupyter/labextensions/jupyterlab-plotly/static/third-party-licenses.json`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/jupyter/nbextensions/jupyterlab-plotly/index.js` & `llm_client-0.6.1/new_venv/share/jupyter/nbextensions/jupyterlab-plotly/index.js`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/jupyter/nbextensions/jupyterlab-plotly/index.js.LICENSE.txt` & `llm_client-0.6.1/new_venv/share/jupyter/nbextensions/jupyterlab-plotly/index.js.LICENSE.txt`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/new_venv/share/man/man1/isympy.1` & `llm_client-0.6.1/new_venv/share/man/man1/isympy.1`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_api_client/test_llm_api_client_factory.py` & `llm_client-0.6.1/tests/llm_api_client/test_llm_api_client_factory.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_api_client/ai21_client/conftest.py` & `llm_client-0.6.1/tests/llm_api_client/ai21_client/conftest.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_api_client/ai21_client/test_ai21.py` & `llm_client-0.6.1/tests/llm_api_client/ai21_client/test_ai21.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_api_client/anthropic_client/conftest.py` & `llm_client-0.6.1/tests/llm_api_client/anthropic_client/conftest.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_api_client/anthropic_client/test_anthropic_client.py` & `llm_client-0.6.1/tests/llm_api_client/anthropic_client/test_anthropic_client.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_api_client/google_client/conftest.py` & `llm_client-0.6.1/tests/llm_api_client/google_client/conftest.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_api_client/google_client/test_google_client.py` & `llm_client-0.6.1/tests/llm_api_client/google_client/test_google_client.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_api_client/huggingface_client/conftest.py` & `llm_client-0.6.1/tests/llm_api_client/huggingface_client/conftest.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_api_client/huggingface_client/test_huggingface.py` & `llm_client-0.6.1/tests/llm_api_client/huggingface_client/test_huggingface.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_api_client/openai_client/conftest.py` & `llm_client-0.6.1/tests/llm_api_client/openai_client/conftest.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_api_client/openai_client/test_openai.py` & `llm_client-0.6.1/tests/llm_api_client/openai_client/test_openai.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_client/local_client/conftest.py` & `llm_client-0.6.1/tests/llm_client/local_client/conftest.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/llm_client/local_client/test_local_client.py` & `llm_client-0.6.1/tests/llm_client/local_client/test_local_client.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/tests/resources/ai21/text_completion.json` & `llm_client-0.6.1/tests/resources/ai21/text_completion.json`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/Activate.ps1` & `llm_client-0.6.1/venv_3_9/bin/Activate.ps1`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/activate` & `llm_client-0.6.1/venv_3_9/bin/activate`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/activate.csh` & `llm_client-0.6.1/venv_3_9/bin/activate.csh`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/activate.fish` & `llm_client-0.6.1/venv_3_9/bin/activate.fish`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/publish.py` & `llm_client-0.6.1/venv_3_9/bin/publish.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/rst2html.py` & `llm_client-0.6.1/venv_3_9/bin/rst2html.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/rst2html4.py` & `llm_client-0.6.1/venv_3_9/bin/rst2html4.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/rst2html5.py` & `llm_client-0.6.1/venv_3_9/bin/rst2html5.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/rst2latex.py` & `llm_client-0.6.1/venv_3_9/bin/rst2latex.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/rst2man.py` & `llm_client-0.6.1/venv_3_9/bin/rst2man.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/rst2odt.py` & `llm_client-0.6.1/venv_3_9/bin/rst2odt.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/rst2odt_prepstyles.py` & `llm_client-0.6.1/venv_3_9/bin/rst2odt_prepstyles.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/rst2pseudoxml.py` & `llm_client-0.6.1/venv_3_9/bin/rst2pseudoxml.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/rst2s5.py` & `llm_client-0.6.1/venv_3_9/bin/rst2s5.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/rst2xetex.py` & `llm_client-0.6.1/venv_3_9/bin/rst2xetex.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/rst2xml.py` & `llm_client-0.6.1/venv_3_9/bin/rst2xml.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_3_9/bin/rstpep2html.py` & `llm_client-0.6.1/venv_3_9/bin/rstpep2html.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_ai21/bin/activate` & `llm_client-0.6.1/venv_ai21/bin/activate`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_ai21/bin/activate.csh` & `llm_client-0.6.1/venv_ai21/bin/activate.csh`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_ai21/bin/activate.fish` & `llm_client-0.6.1/venv_ai21/bin/activate.fish`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_ai21/bin/activate.nu` & `llm_client-0.6.1/venv_ai21/bin/activate.nu`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_ai21/bin/activate.ps1` & `llm_client-0.6.1/venv_ai21/bin/activate.ps1`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_ai21/bin/activate_this.py` & `llm_client-0.6.1/venv_ai21/bin/activate_this.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_ai21/bin/deactivate.nu` & `llm_client-0.6.1/venv_ai21/bin/deactivate.nu`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_local/bin/activate` & `llm_client-0.6.1/venv_local/bin/activate`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_local/bin/activate.csh` & `llm_client-0.6.1/venv_local/bin/activate.csh`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_local/bin/activate.fish` & `llm_client-0.6.1/venv_local/bin/activate.fish`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_local/bin/activate.nu` & `llm_client-0.6.1/venv_local/bin/activate.nu`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_local/bin/activate.ps1` & `llm_client-0.6.1/venv_local/bin/activate.ps1`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_local/bin/activate_this.py` & `llm_client-0.6.1/venv_local/bin/activate_this.py`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/venv_local/bin/deactivate.nu` & `llm_client-0.6.1/venv_local/bin/deactivate.nu`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/.gitignore` & `llm_client-0.6.1/.gitignore`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/LICENSE` & `llm_client-0.6.1/LICENSE`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/README.md` & `llm_client-0.6.1/README.md`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/pyproject.toml` & `llm_client-0.6.1/pyproject.toml`

 * *Files identical despite different names*

### Comparing `llm_client-0.6.0/PKG-INFO` & `llm_client-0.6.1/PKG-INFO`
