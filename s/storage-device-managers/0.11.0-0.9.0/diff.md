# Comparing `tmp/storage_device_managers-0.11.0.tar.gz` & `tmp/storage_device_managers-0.9.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "storage_device_managers-0.11.0.tar", max compression
+gzip compressed data, was "storage_device_managers-0.9.0.tar", max compression
```

## Comparing `storage_device_managers-0.11.0.tar` & `storage_device_managers-0.9.0.tar`

### file list

```diff
@@ -1,6 +1,6 @@
--rw-r--r--   0        0        0    35106 2023-06-15 19:36:56.857826 storage_device_managers-0.11.0/LICENSE
--rw-r--r--   0        0        0     1250 2023-06-16 01:22:14.592656 storage_device_managers-0.11.0/pyproject.toml
--rw-r--r--   0        0        0      801 2023-06-15 23:49:34.488114 storage_device_managers-0.11.0/src/storage_device_managers/__init__.py
--rw-r--r--   0        0        0        0 2023-06-15 20:47:57.614397 storage_device_managers-0.11.0/src/storage_device_managers/py.typed
--rw-r--r--   0        0        0    10724 2023-06-16 01:20:56.164340 storage_device_managers-0.11.0/src/storage_device_managers/storage_device_managers.py
--rw-r--r--   0        0        0      646 1970-01-01 00:00:00.000000 storage_device_managers-0.11.0/PKG-INFO
...
### Comparing `storage_device_managers-0.11.0/LICENSE` & `storage_device_managers-0.9.0/LICENSE`

 * *Files identical despite different names*

### Comparing `storage_device_managers-0.11.0/pyproject.toml` & `storage_device_managers-0.9.0/pyproject.toml`
...
### Comparing `storage_device_managers-0.11.0/src/storage_device_managers/__init__.py` & `storage_device_managers-0.9.0/src/storage_device_managers/__init__.py`
...
### Comparing `storage_device_managers-0.11.0/src/storage_device_managers/storage_device_managers.py` & `storage_device_managers-0.9.0/src/storage_device_managers/storage_device_managers.py`
...
### Comparing `storage_device_managers-0.11.0/PKG-INFO` & `storage_device_managers-0.9.0/PKG-INFO`
