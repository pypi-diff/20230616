# Comparing `tmp/aolab-bmi3d-0.9.2.tar.gz` & `tmp/aolab-bmi3d-0.9.3.tar.gz`
...
### Comparing `aolab-bmi3d-0.9.2/db/tracker/json_param.py` & `aolab-bmi3d-0.9.3/db/tracker/json_param.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/db/tracker/migrations/0001_initial.py` & `aolab-bmi3d-0.9.3/db/tracker/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/db/tracker/migrations/0002_auto_20191112_2306.py` & `aolab-bmi3d-0.9.3/db/tracker/migrations/0002_auto_20191112_2306.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/db/tracker/migrations/0003_auto_20191113_2158.py` & `aolab-bmi3d-0.9.3/db/tracker/migrations/0003_auto_20191113_2158.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/db/tracker/migrations/0004_keyvaluestore.py` & `aolab-bmi3d-0.9.3/db/tracker/migrations/0004_keyvaluestore.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/db/tracker/migrations/0010_experimenter.py` & `aolab-bmi3d-0.9.3/db/tracker/migrations/0010_experimenter.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/db/tracker/migrations/0011_auto_20211017_1548.py` & `aolab-bmi3d-0.9.3/db/tracker/migrations/0011_auto_20211017_1548.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/db/tracker/models.py` & `aolab-bmi3d-0.9.3/db/tracker/models.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/db/tracker/tasktrack.py` & `aolab-bmi3d-0.9.3/db/tracker/tasktrack.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/db/tracker/trainbmi.py` & `aolab-bmi3d-0.9.3/db/tracker/trainbmi.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/db/tracker/views.py` & `aolab-bmi3d-0.9.3/db/tracker/views.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/db/tracker/websocket.py` & `aolab-bmi3d-0.9.3/db/tracker/websocket.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/db/urls.py` & `aolab-bmi3d-0.9.3/db/urls.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/__init__.py` & `aolab-bmi3d-0.9.3/features/__init__.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/arduino_features.py` & `aolab-bmi3d-0.9.3/features/arduino_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/blackrock_features.py` & `aolab-bmi3d-0.9.3/features/blackrock_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/bmi_task_features.py` & `aolab-bmi3d-0.9.3/features/bmi_task_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/ecube_features.py` & `aolab-bmi3d-0.9.3/features/ecube_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/eyetracker_features.py` & `aolab-bmi3d-0.9.3/features/eyetracker_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/generator_features.py` & `aolab-bmi3d-0.9.3/features/generator_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/hdf_features.py` & `aolab-bmi3d-0.9.3/features/hdf_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/kinarm_features.py` & `aolab-bmi3d-0.9.3/features/kinarm_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/laser_features.py` & `aolab-bmi3d-0.9.3/features/laser_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/neural_sys_features.py` & `aolab-bmi3d-0.9.3/features/neural_sys_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/optitrack_features.py` & `aolab-bmi3d-0.9.3/features/optitrack_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/peripheral_device_features.py` & `aolab-bmi3d-0.9.3/features/peripheral_device_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/phasespace_features.py` & `aolab-bmi3d-0.9.3/features/phasespace_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/plexon_features.py` & `aolab-bmi3d-0.9.3/features/plexon_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/reward_features.py` & `aolab-bmi3d-0.9.3/features/reward_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/serial_port_sensor.py` & `aolab-bmi3d-0.9.3/features/serial_port_sensor.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/simulation_features.py` & `aolab-bmi3d-0.9.3/features/simulation_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/sync_features.py` & `aolab-bmi3d-0.9.3/features/sync_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/touch_features.py` & `aolab-bmi3d-0.9.3/features/touch_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/features/video_recording_features.py` & `aolab-bmi3d-0.9.3/features/video_recording_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/arduino_imu.py` & `aolab-bmi3d-0.9.3/riglib/arduino_imu.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/arduino_joystick.py` & `aolab-bmi3d-0.9.3/riglib/arduino_joystick.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/blackrock/__init__.py` & `aolab-bmi3d-0.9.3/riglib/blackrock/__init__.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/blackrock/brMiscFxns.py` & `aolab-bmi3d-0.9.3/riglib/blackrock/brMiscFxns.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/blackrock/brpylib.py` & `aolab-bmi3d-0.9.3/riglib/blackrock/brpylib.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/blackrock/cerelink.py` & `aolab-bmi3d-0.9.3/riglib/blackrock/cerelink.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/accumulator.py` & `aolab-bmi3d-0.9.3/riglib/bmi/accumulator.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/assist.py` & `aolab-bmi3d-0.9.3/riglib/bmi/assist.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/bmi.py` & `aolab-bmi3d-0.9.3/riglib/bmi/bmi.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/clda.py` & `aolab-bmi3d-0.9.3/riglib/bmi/clda.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/extractor.py` & `aolab-bmi3d-0.9.3/riglib/bmi/extractor.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/feedback_controllers.py` & `aolab-bmi3d-0.9.3/riglib/bmi/feedback_controllers.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/goal_calculators.py` & `aolab-bmi3d-0.9.3/riglib/bmi/goal_calculators.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/kfdecoder.py` & `aolab-bmi3d-0.9.3/riglib/bmi/kfdecoder.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/kfdecoder_fcns.py` & `aolab-bmi3d-0.9.3/riglib/bmi/kfdecoder_fcns.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/lindecoder.py` & `aolab-bmi3d-0.9.3/riglib/bmi/lindecoder.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/onedim_lfp_decoder.py` & `aolab-bmi3d-0.9.3/riglib/bmi/onedim_lfp_decoder.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/ppfdecoder.py` & `aolab-bmi3d-0.9.3/riglib/bmi/ppfdecoder.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/rat_bmi_decoder.py` & `aolab-bmi3d-0.9.3/riglib/bmi/rat_bmi_decoder.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/robot_arms.py` & `aolab-bmi3d-0.9.3/riglib/bmi/robot_arms.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/sim_neurons.py` & `aolab-bmi3d-0.9.3/riglib/bmi/sim_neurons.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/sskfdecoder.py` & `aolab-bmi3d-0.9.3/riglib/bmi/sskfdecoder.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/state_space_models.py` & `aolab-bmi3d-0.9.3/riglib/bmi/state_space_models.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/bmi/train.py` & `aolab-bmi3d-0.9.3/riglib/bmi/train.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/button.py` & `aolab-bmi3d-0.9.3/riglib/button.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/calibrations.py` & `aolab-bmi3d-0.9.3/riglib/calibrations.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/dio/NIUSB6501/control_comedi_swig.py` & `aolab-bmi3d-0.9.3/riglib/dio/NIUSB6501/control_comedi_swig.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/dio/NIUSB6501/py_comedi_control.py` & `aolab-bmi3d-0.9.3/riglib/dio/NIUSB6501/py_comedi_control.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/dio/nidaq/__init__.py` & `aolab-bmi3d-0.9.3/riglib/dio/nidaq/__init__.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/dio/parse.py` & `aolab-bmi3d-0.9.3/riglib/dio/parse.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/e3vision.py` & `aolab-bmi3d-0.9.3/riglib/e3vision.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/ecube/__init__.py` & `aolab-bmi3d-0.9.3/riglib/ecube/__init__.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/ecube/file.py` & `aolab-bmi3d-0.9.3/riglib/ecube/file.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/ecube/pyeCubeStream.py` & `aolab-bmi3d-0.9.3/riglib/ecube/pyeCubeStream.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/experiment/Pygame.py` & `aolab-bmi3d-0.9.3/riglib/experiment/Pygame.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/experiment/__init__.py` & `aolab-bmi3d-0.9.3/riglib/experiment/__init__.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/experiment/experiment.py` & `aolab-bmi3d-0.9.3/riglib/experiment/experiment.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/experiment/generate.py` & `aolab-bmi3d-0.9.3/riglib/experiment/generate.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/experiment/mocks.py` & `aolab-bmi3d-0.9.3/riglib/experiment/mocks.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/experiment/report.py` & `aolab-bmi3d-0.9.3/riglib/experiment/report.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/experiment/task_wrapper.py` & `aolab-bmi3d-0.9.3/riglib/experiment/task_wrapper.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/eyetracker.py` & `aolab-bmi3d-0.9.3/riglib/eyetracker.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/filter.py` & `aolab-bmi3d-0.9.3/riglib/filter.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/fsm/fsm/fsm.py` & `aolab-bmi3d-0.9.3/riglib/fsm/fsm/fsm.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/gpio.py` & `aolab-bmi3d-0.9.3/riglib/gpio.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/hdfwriter/hdfwriter.py` & `aolab-bmi3d-0.9.3/riglib/hdfwriter/hdfwriter.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/kinarmdata.py` & `aolab-bmi3d-0.9.3/riglib/kinarmdata.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/kinarmsocket.py` & `aolab-bmi3d-0.9.3/riglib/kinarmsocket.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/master8stimulation.py` & `aolab-bmi3d-0.9.3/riglib/master8stimulation.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/motiontracker.py` & `aolab-bmi3d-0.9.3/riglib/motiontracker.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/mp_calc.py` & `aolab-bmi3d-0.9.3/riglib/mp_calc.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/mp_proxy.py` & `aolab-bmi3d-0.9.3/riglib/mp_proxy.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/optitrack_client/optitrack.py` & `aolab-bmi3d-0.9.3/riglib/optitrack_client/optitrack.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/optitrack_client/optitrack_interface_sijia.py` & `aolab-bmi3d-0.9.3/riglib/optitrack_client/optitrack_interface_sijia.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/phidgets.py` & `aolab-bmi3d-0.9.3/riglib/phidgets.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/plants.py` & `aolab-bmi3d-0.9.3/riglib/plants.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/positioner/__init__.py` & `aolab-bmi3d-0.9.3/riglib/positioner/__init__.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/positioner/calib.py` & `aolab-bmi3d-0.9.3/riglib/positioner/calib.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/qwalor_laser.py` & `aolab-bmi3d-0.9.3/riglib/qwalor_laser.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/reward.py` & `aolab-bmi3d-0.9.3/riglib/reward.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/reward_crist.py` & `aolab-bmi3d-0.9.3/riglib/reward_crist.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/serial_dio.py` & `aolab-bmi3d-0.9.3/riglib/serial_dio.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/singleton.py` & `aolab-bmi3d-0.9.3/riglib/singleton.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/sink.py` & `aolab-bmi3d-0.9.3/riglib/sink.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/source.py` & `aolab-bmi3d-0.9.3/riglib/source.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/environment.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/environment.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/ik.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/ik.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/models.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/models.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/primitives.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/primitives.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/render/fbo.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/render/fbo.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/render/render.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/render/render.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/render/shader.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/render/shader.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/render/ssao.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/render/ssao.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/render/stereo.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/render/stereo.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/textures.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/textures.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/utils.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/utils.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/window.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/window.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stereo_opengl/xfm.py` & `aolab-bmi3d-0.9.3/riglib/stereo_opengl/xfm.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/stimulus_pulse.py` & `aolab-bmi3d-0.9.3/riglib/stimulus_pulse.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/tablet_reward.py` & `aolab-bmi3d-0.9.3/riglib/tablet_reward.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/riglib/touch_data.py` & `aolab-bmi3d-0.9.3/riglib/touch_data.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/Link.py` & `aolab-bmi3d-0.9.3/robot/Link.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/Quaternion.py` & `aolab-bmi3d-0.9.3/robot/Quaternion.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/Robot.py` & `aolab-bmi3d-0.9.3/robot/Robot.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/SerialLink.py` & `aolab-bmi3d-0.9.3/robot/SerialLink.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/dynamics.py` & `aolab-bmi3d-0.9.3/robot/dynamics.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/jacobian.py` & `aolab-bmi3d-0.9.3/robot/jacobian.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/kinematics.py` & `aolab-bmi3d-0.9.3/robot/kinematics.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/manipulability.py` & `aolab-bmi3d-0.9.3/robot/manipulability.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/parsedemo.py` & `aolab-bmi3d-0.9.3/robot/parsedemo.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/plot.py` & `aolab-bmi3d-0.9.3/robot/plot.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/trajectory.py` & `aolab-bmi3d-0.9.3/robot/trajectory.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/transform.py` & `aolab-bmi3d-0.9.3/robot/transform.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/robot/utility.py` & `aolab-bmi3d-0.9.3/robot/utility.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/setup.py` & `aolab-bmi3d-0.9.3/setup.py`
...
### Comparing `aolab-bmi3d-0.9.2/tests/test_decoders.py` & `aolab-bmi3d-0.9.3/tests/test_decoders.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/tests/test_ecube.py` & `aolab-bmi3d-0.9.3/tests/test_ecube.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/tests/test_features.py` & `aolab-bmi3d-0.9.3/tests/test_features.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/tests/test_qwalor_laser.py` & `aolab-bmi3d-0.9.3/tests/test_qwalor_laser.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/tests/test_reward.py` & `aolab-bmi3d-0.9.3/tests/test_reward.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/tests/test_tasks.py` & `aolab-bmi3d-0.9.3/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/utils/angle_utils.py` & `aolab-bmi3d-0.9.3/utils/angle_utils.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/utils/drawbox.py` & `aolab-bmi3d-0.9.3/utils/drawbox.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/utils/fixpaths.py` & `aolab-bmi3d-0.9.3/utils/fixpaths.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/utils/make_autoalign.py` & `aolab-bmi3d-0.9.3/utils/make_autoalign.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/utils/reassociate.py` & `aolab-bmi3d-0.9.3/utils/reassociate.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/utils/ringbuffer.py` & `aolab-bmi3d-0.9.3/utils/ringbuffer.py`

 * *Files identical despite different names*

### Comparing `aolab-bmi3d-0.9.2/utils/util_fns.py` & `aolab-bmi3d-0.9.3/utils/util_fns.py`
