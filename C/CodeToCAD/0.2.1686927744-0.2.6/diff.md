# Comparing `tmp/CodeToCAD-0.2.1686927744.tar.gz` & `tmp/CodeToCAD-0.2.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "CodeToCAD-0.2.1686927744.tar", last modified: Fri Jun 16 15:03:15 2023, max compression
+gzip compressed data, was "CodeToCAD-0.2.6.tar", last modified: Tue Mar 14 18:44:06 2023, max compression
```

## Comparing `CodeToCAD-0.2.1686927744.tar` & `CodeToCAD-0.2.6.tar`

### file list

```diff
@@ -1,19 +1,17 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-16 15:03:15.005324 CodeToCAD-0.2.1686927744/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-16 15:03:15.005324 CodeToCAD-0.2.1686927744/CodeToCAD/
--rw-r--r--   0 runner    (1001) docker     (123)    58082 2023-06-16 15:03:06.000000 CodeToCAD-0.2.1686927744/CodeToCAD/CodeToCADInterface.py
--rw-r--r--   0 runner    (1001) docker     (123)    25087 2023-06-16 15:03:06.000000 CodeToCAD-0.2.1686927744/CodeToCAD/CodeToCADProvider.py
--rw-r--r--   0 runner    (1001) docker     (123)    36660 2023-06-16 15:03:06.000000 CodeToCAD-0.2.1686927744/CodeToCAD/TestCodeToCADProvider.py
--rw-r--r--   0 runner    (1001) docker     (123)     4390 2023-06-16 15:03:06.000000 CodeToCAD-0.2.1686927744/CodeToCAD/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    33016 2023-06-16 15:03:06.000000 CodeToCAD-0.2.1686927744/CodeToCAD/utilities.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-16 15:03:15.005324 CodeToCAD-0.2.1686927744/CodeToCAD.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     7059 2023-06-16 15:03:14.000000 CodeToCAD-0.2.1686927744/CodeToCAD.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      325 2023-06-16 15:03:14.000000 CodeToCAD-0.2.1686927744/CodeToCAD.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-16 15:03:14.000000 CodeToCAD-0.2.1686927744/CodeToCAD.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       10 2023-06-16 15:03:14.000000 CodeToCAD-0.2.1686927744/CodeToCAD.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)    32473 2023-06-16 15:03:06.000000 CodeToCAD-0.2.1686927744/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)       19 2023-06-16 15:03:06.000000 CodeToCAD-0.2.1686927744/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     7059 2023-06-16 15:03:15.005324 CodeToCAD-0.2.1686927744/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     6517 2023-06-16 15:03:06.000000 CodeToCAD-0.2.1686927744/README.md
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-06-16 15:03:15.005324 CodeToCAD-0.2.1686927744/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1079 2023-06-16 15:03:06.000000 CodeToCAD-0.2.1686927744/setup.py
--rw-r--r--   0 runner    (1001) docker     (123)       10 2023-06-16 15:03:14.000000 CodeToCAD-0.2.1686927744/version.txt
...
### Comparing `CodeToCAD-0.2.1686927744/CodeToCAD/CodeToCADInterface.py` & `CodeToCAD-0.2.6/CodeToCAD/CodeToCADInterface.py`
...
### Comparing `CodeToCAD-0.2.1686927744/CodeToCAD/TestCodeToCADProvider.py` & `CodeToCAD-0.2.6/CodeToCAD/TestCodeToCADProvider.py`
...
### Comparing `CodeToCAD-0.2.1686927744/CodeToCAD/__init__.py` & `CodeToCAD-0.2.6/CodeToCAD/__init__.py`
...
### Comparing `CodeToCAD-0.2.1686927744/CodeToCAD/utilities.py` & `CodeToCAD-0.2.6/CodeToCAD/utilities.py`
...
### Comparing `CodeToCAD-0.2.1686927744/LICENSE` & `CodeToCAD-0.2.6/LICENSE`

 * *Files identical despite different names*

### Comparing `CodeToCAD-0.2.1686927744/README.md` & `CodeToCAD-0.2.6/CodeToCAD.egg-info/PKG-INFO`
