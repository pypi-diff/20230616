# Comparing `tmp/hspylib-vault-0.9.83.tar.gz` & `tmp/hspylib-vault-0.9.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "hspylib-vault-0.9.83.tar", last modified: Fri Jun 16 21:22:18 2023, max compression
+gzip compressed data, was "hspylib-vault-0.9.9.tar", last modified: Tue Feb 22 20:01:27 2022, max compression
```

## Comparing `hspylib-vault-0.9.83.tar` & `hspylib-vault-0.9.9.tar`

### file list

```diff
@@ -1,32 +1,37 @@
-drwxr-xr-x   0 hjunior    (504) staff       (20)        0 2023-06-16 21:22:17.999384 hspylib-vault-0.9.83/
--rw-r--r--   0 hjunior    (504) staff       (20)       96 2022-06-17 15:16:57.000000 hspylib-vault-0.9.83/MANIFEST.in
--rw-r--r--   0 hjunior    (504) staff       (20)     1543 2023-06-16 21:22:17.998337 hspylib-vault-0.9.83/PKG-INFO
--rw-r--r--   0 hjunior    (504) staff       (20)      675 2023-06-16 21:22:17.000000 hspylib-vault-0.9.83/README.md
-drwxr-xr-x   0 hjunior    (504) staff       (20)        0 2023-06-16 21:22:17.961027 hspylib-vault-0.9.83/hspylib_vault.egg-info/
--rw-r--r--   0 hjunior    (504) staff       (20)     1543 2023-06-16 21:22:17.000000 hspylib-vault-0.9.83/hspylib_vault.egg-info/PKG-INFO
--rw-r--r--   0 hjunior    (504) staff       (20)      585 2023-06-16 21:22:17.000000 hspylib-vault-0.9.83/hspylib_vault.egg-info/SOURCES.txt
--rw-r--r--   0 hjunior    (504) staff       (20)        1 2023-06-16 21:22:17.000000 hspylib-vault-0.9.83/hspylib_vault.egg-info/dependency_links.txt
--rw-r--r--   0 hjunior    (504) staff       (20)       73 2023-06-16 21:22:17.000000 hspylib-vault-0.9.83/hspylib_vault.egg-info/requires.txt
--rw-r--r--   0 hjunior    (504) staff       (20)        6 2023-06-16 21:22:17.000000 hspylib-vault-0.9.83/hspylib_vault.egg-info/top_level.txt
--rw-r--r--   0 hjunior    (504) staff       (20)       38 2023-06-16 21:22:17.999577 hspylib-vault-0.9.83/setup.cfg
--rw-r--r--   0 hjunior    (504) staff       (20)     1854 2023-04-19 22:13:51.000000 hspylib-vault-0.9.83/setup.py
-drwxr-xr-x   0 hjunior    (504) staff       (20)        0 2023-06-16 21:22:17.971014 hspylib-vault-0.9.83/vault/
--rw-r--r--   0 hjunior    (504) staff       (20)        6 2023-06-16 21:22:17.000000 hspylib-vault-0.9.83/vault/.version
--rw-r--r--   0 hjunior    (504) staff       (20)      716 2023-04-19 22:01:58.000000 hspylib-vault-0.9.83/vault/__classpath__.py
--rw-r--r--   0 hjunior    (504) staff       (20)      180 2023-06-16 21:22:17.000000 hspylib-vault-0.9.83/vault/__init__.py
--rw-r--r--   0 hjunior    (504) staff       (20)     5147 2023-04-19 22:13:51.000000 hspylib-vault-0.9.83/vault/__main__.py
-drwxr-xr-x   0 hjunior    (504) staff       (20)        0 2023-06-16 21:22:17.982793 hspylib-vault-0.9.83/vault/core/
--rw-r--r--   0 hjunior    (504) staff       (20)      219 2023-06-16 21:22:17.000000 hspylib-vault-0.9.83/vault/core/__init__.py
--rw-r--r--   0 hjunior    (504) staff       (20)    13235 2023-06-16 21:19:22.000000 hspylib-vault-0.9.83/vault/core/vault.py
--rw-r--r--   0 hjunior    (504) staff       (20)     1395 2023-04-19 22:18:03.000000 hspylib-vault-0.9.83/vault/core/vault_config.py
--rw-r--r--   0 hjunior    (504) staff       (20)     1852 2023-04-19 22:18:03.000000 hspylib-vault-0.9.83/vault/core/vault_repository.py
--rw-r--r--   0 hjunior    (504) staff       (20)     2358 2023-04-19 22:18:03.000000 hspylib-vault-0.9.83/vault/core/vault_service.py
-drwxr-xr-x   0 hjunior    (504) staff       (20)        0 2023-06-16 21:22:17.988523 hspylib-vault-0.9.83/vault/domain/
--rw-r--r--   0 hjunior    (504) staff       (20)      165 2023-06-16 21:22:17.000000 hspylib-vault-0.9.83/vault/domain/__init__.py
--rw-r--r--   0 hjunior    (504) staff       (20)     3466 2023-04-19 22:18:03.000000 hspylib-vault-0.9.83/vault/domain/vault_entry.py
-drwxr-xr-x   0 hjunior    (504) staff       (20)        0 2023-06-16 21:22:17.994164 hspylib-vault-0.9.83/vault/exception/
--rw-r--r--   0 hjunior    (504) staff       (20)      167 2023-06-16 21:22:17.000000 hspylib-vault-0.9.83/vault/exception/__init__.py
--rw-r--r--   0 hjunior    (504) staff       (20)      839 2023-04-19 22:01:58.000000 hspylib-vault-0.9.83/vault/exception/exceptions.py
-drwxr-xr-x   0 hjunior    (504) staff       (20)        0 2023-06-16 21:22:17.996218 hspylib-vault-0.9.83/vault/resources/
--rw-r--r--   0 hjunior    (504) staff       (20)       69 2022-11-12 19:14:13.000000 hspylib-vault-0.9.83/vault/resources/application.properties
--rw-r--r--   0 hjunior    (504) staff       (20)      168 2023-04-19 21:58:35.000000 hspylib-vault-0.9.83/vault/welcome.txt
...
### Comparing `hspylib-vault-0.9.83/hspylib_vault.egg-info/SOURCES.txt` & `hspylib-vault-0.9.9/hspylib_vault.egg-info/SOURCES.txt`
...
### Comparing `hspylib-vault-0.9.83/vault/exception/exceptions.py` & `hspylib-vault-0.9.9/vault/exception/exceptions.py`
